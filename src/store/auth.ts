...
export const useUserStore = defineStore("user", {
    state: () => ({
        ...
        roles: (sessionStorage.getItem("roles") ? JSON.parse(sessionStorage.getItem("roles")!) : []) as string[],
        username: sessionStorage.getItem("username") || "",
        menu: (sessionStorage.getItem("menu") ? JSON.parse(sessionStorage.getItem("menu")!) : []) as MenuItem[]
    }),
    actions: {
